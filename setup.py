...
setuptools.setup(
    ...
    entry_points={
        ...
        'helix.commands': [
            ...
            define_command('01_prep_patchman'),
            define_command('02_patchman'),
            define_command('03_design_patchman'),
            define_command('04_filter'),
            define_command('05_match'),
            define_command('06_score_matches'),
            define_command("07_export_matches"),
            define_command('08_design_scaffolds'),
            define_command('09_filter_designs'),
